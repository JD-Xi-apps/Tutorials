  ...
  entries: {
    ...
    "menu-controls": {
      ...
      steps: [
        ...
        "Shift with Cursor moves between the major groups of a settings screen.",
      ...
      source: "Owner's Manual p.2, p.13, p.14",
      learnIn: ["N01"],
    },
    ...
    shortcuts: {
      ...
      steps: [
        ...
        "Shift + Cursor — move between the major groups of a settings screen.",
      ...
      source: "Owner's Manual p.16, Shortcut List",
      learnIn: ["N01", "N10"],
    },
