...
| Field | Value |
|---|---|
| Tutorial | **I09 — Save and organize creations** (intermediate, order 9, 12 steps, ~13 min) |
...
would be composing a display state rather than reproducing one, so `I09-S11` describes
both operations in prose and shows neither. The `Completed. Turn off power.` screen is
likewise described rather than reproduced in `I09-S10`.
...
`I09-S10`'s instruction is literally "Read this, and do not perform it now", and its
...
I09-S12's `recoveryHelp` carries the one risk in renaming: saving to the same slot is
...
|---|---|---|---|
| I09-S05 – I09-S07 | Startup Program | **1.50+** | v1.50 p.3 |
| I09-S11 | Export and Extra Banks | **1.10+** | v1.10 pp.1–2 |
...
- the tutorial establishes the starting value before changing it — I09-S07's instruction
...
currently set to, whether a computer is available (I09-S08's `recoveryHelp` says the
